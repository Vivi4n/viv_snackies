...
ESX.RegisterUsableItem('burger', function(source)
    ...
    TrigerClientEvent('esx_status:add', source 'hunger', 220000)
...
ESX.RegisterUsableItem('chips', function(source)
    ...
    TrigerClientEvent('esx_status:add', source 'hunger', 100000)
    TriggerClientEvent('esx_basicneeds:onEat', source)
...
ESX.RegisterUsableItem('monster', function(source)
    ...
    TrigerClientEvent('esx_status:add', source 'thirst', 220000)
